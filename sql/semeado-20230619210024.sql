...
Backup Time: 2023-06-19 21:00:25
*/
...
INSERT INTO "public"."products" ("prd_id","prd_id_user","prd_id_type","prd_name","prd_price") VALUES (1, 1, 3, 'Ponta de Peito', 28.9),(2, 1, 2, 'Pão Francês', 32.99),(3, 1, 1, 'Rúcula', 5.45),(4, 1, 1, 'Repolho', 156.932),(5, 1, 1, 'Maracujá', 18.35),(6, 1, 1, 'Testes', 15.23),(7, 1, 1, 'Testes (Atualizado)', 15.3),(8, 1, 1, 'Testes', 15.23);
COMMIT;
BEGIN;
LOCK TABLE "public"."products_types" IN SHARE MODE;
DELETE FROM "public"."products_types";
INSERT INTO "public"."products_types" ("tpo_id","tpo_id_user","tpo_description","tpo_tax") VALUES (1, 1, 'Hortifruti', 31.5),(2, 1, 'Limpeza', 32),(3, 1, 'Açougue', 45.34),(4, 1, 'Padaria', 25),(5, 1, 'Utensílios', 25.3),(6, 1, 'Frios', 31.12),(7, 1, 'Doces', 42),(8, 1, 'Hortifrut', 8);
COMMIT;
BEGIN;
LOCK TABLE "public"."sales" IN SHARE MODE;
DELETE FROM "public"."sales";
INSERT INTO "public"."sales" ("sls_id","sls_id_user","sls_client","sls_total_price","sls_date","sls_total_price_taxes") VALUES (1, 1, '42109479892', 1502.504, '2023-06-19 23:59:17.739547', 497.61722);
COMMIT;
BEGIN;
LOCK TABLE "public"."sales_items" IN SHARE MODE;
DELETE FROM "public"."sales_items";
INSERT INTO "public"."sales_items" ("sls_ite_id","sls_ite_id_product","sls_ite_description","sls_ite_price","sls_ite_qtd","sls_ite_tax","sls_ite_id_sale","sls_ite_price_total","sls_ite_tax_total") VALUES (1, 1, 'Ponta de Peito', 28.9, 6, 45.34, 1, 173.4, 78.61956),(2, 2, 'Pão Francês', 32.99, 2, 32, 1, 65.98, 21.113602),(3, 3, 'Rúcula', 5.45, 10, 31.5, 1, 54.5, 17.1675),(4, 4, 'Repolho', 156.932, 7, 31.5, 1, 1098.524, 346.03506),(5, 5, 'Maracujá', 18.35, 6, 31.5, 1, 110.100006, 34.6815);
COMMIT;
BEGIN;
